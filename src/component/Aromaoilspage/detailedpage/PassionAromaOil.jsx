  ...
  return (
    <div className="mt-16 bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-hidden tracking-tight">
      ...
      <section className="py-24 bg-slate-50 px-6 lg:px-12 font-sans">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <div className="bg-white p-12 md:p-20 rounded-[3rem] shadow-sm border border-slate-100 max-w-4xl mx-auto">
             ...
             <h3 className="text-xl font-serif font-bold mb-6 text-slate-950 uppercase italic">Fragrance Notes Overview</h3>
             <p className="text-lg text-slate-600 leading-relaxed font-light mb-8">
                Passion Aroma Oil is designed with a strong and impactful fragrance composition.
             </p>
             <p className="text-base text-slate-500 leading-relaxed font-light mb-8 italic">
      ...
      <section className="py-24 bg-white px-6 font-sans">
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 items-center">
           <div>
             ...
             <p className="mt-10 text-slate-500 leading-relaxed font-light italic">
      ...
      <section className="py-24 bg-slate-950 text-white px-6 font-sans">
        <div className="max-w-[1200px] mx-auto text-center">
            <h2 className="text-3xl md:text-5xl font-serif mb-20 tracking-tight text-blue-400 italic font-light uppercase">Why Choose Passion Aroma?</h2>
      ...
      <section className="py-24 px-6">
        <div className="max-w-[1200px] mx-auto bg-slate-950 rounded-[4rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-2xl font-sans">
          ...
          <h2 className="text-4xl md:text-7xl font-serif mb-10 relative z-10 tracking-tighter leading-tight uppercase ">Interested in <br/><span className="italic font-light text-slate-300 font-serif">this fragrance?</span></h2>
          <p className="text-slate-400 text-lg md:text-2xl mb-12 relative z-10 max-w-3xl mx-auto leading-relaxed font-light">
            Our team can help you choose the right diffuser system and customize fragrance intensity based on your space needs.
          </p>
