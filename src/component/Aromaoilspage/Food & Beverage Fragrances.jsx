  ...
  const oils = [
    {
      ...
      code: "CM-0106-OR",
      strength: "Medium",
      path: "/aroma/true-coffee", // Updated to match App.js Route
        ...
        <div className="max-w-[1000px] mx-auto text-center">
          <motion.div {...fadeUp}>
            <h2 className="text-3xl md:text-6xl font-serif mb-10 tracking-tight text-slate-950 leading-tight uppercase">
              About Our <span className="italic font-light text-slate-700">Food & Beverage Oils</span>
            </h2>
        ...
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            {[
              ...
              { icon: CakeIcon, label: "Bakeries & Dessert" },
              { icon: BuildingOffice2Icon, label: "Food Courts" },
              { icon: SparklesIcon, label: "Hospitality Dining" }
            ].map((item, i) => (
