    ...
    <div className="bg-[#FAF9F6] text-slate-900 font-sans selection:bg-blue-100 overflow-hidden">
        ...
        <div className="grid gap-16">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="order-2 md:order-1">
              <h3 className="text-xl font-serif mb-4">No-Climbing Oil Replacement System</h3>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="text-left">
              <h3 className="text-xl font-serif mb-4">Smart Bluetooth Control</h3>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-blue-600 text-white p-8 rounded-[2rem] shadow-xl shadow-blue-100 text-left">
               ...
               <h3 className="text-xl font-serif mb-2">Quiet & Discreet Operation</h3>
          ...
          <div className="p-10 bg-white border border-slate-100 rounded-[2.5rem] shadow-sm flex flex-col items-center text-center">
             ...
             <h3 className="text-xl md:text-3xl font-serif mb-4">Installation Flexibility</h3>
      ...
      <section className="py-16 px-6 lg:px-12 max-w-[1400px] mx-auto text-center">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center text-left">
          ...
          <div>
            <h2 className="text-2xl md:text-4xl font-serif mb-6 tracking-tight leading-tight">Why Choose CeilAir Pro Diffuser</h2>
      ...
      <section className="py-16 bg-slate-50 px-6">
        <div className="max-w-[1200px] mx-auto text-center border-t border-slate-100 pt-16">
          <h2 className="text-2xl md:text-4xl font-serif mb-6 tracking-tight">The Wall-Mounted & Ceiling Range</h2>
          ...
          <div className="max-w-xs mx-auto">
            <div className="p-6 rounded-2xl bg-white border border-slate-100 hover:border-blue-600 transition-all font-bold uppercase tracking-widest text-[9px] text-slate-500 cursor-pointer">
      ...
      <section className="py-20 px-6">
        <div className="max-w-[1200px] mx-auto bg-[#0c101b] rounded-[3rem] p-10 md:p-16 text-center text-white relative overflow-hidden shadow-2xl">
          ...
          <h2 className="text-3xl md:text-5xl font-serif mb-6 relative z-10 tracking-tight leading-tight uppercase">Upgrade Your Commercial Space</h2>
