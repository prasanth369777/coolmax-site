        ...
        <div className="grid gap-16">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="order-2 md:order-1">
              <h3 className="text-xl font-serif mb-4">Dual Power Flexibility</h3>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 mb-4 font-light">The diffuser features a smart LCD display combined with Bluetooth remote control, allowing managers to:</p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white border border-slate-100 p-8 rounded-[2rem] shadow-sm text-left">
               ...
               <h3 className="text-xl font-serif mb-2">Quiet & Energy-Efficient</h3>
               <p className="text-slate-500 text-xs leading-relaxed mb-4 font-light italic">With noise levels below 35 dB, LuxePanel operates quietly, making it ideal for environments where silence and comfort are essential.</p>
          ...
          <div className="p-10 bg-white border border-slate-100 rounded-[2.5rem] shadow-sm flex flex-col items-center text-center">
             ...
             <h3 className="text-xl md:text-3xl font-serif mb-4">Compact & Minimalist Design</h3>
             <p className="text-slate-500 max-w-xl mx-auto text-sm leading-relaxed font-light">LuxePanel Diffuser is designed with a slim, modern profile that blends effortlessly into professional interiors. Its compact size makes it suitable for wall-mounted or discreet placement without disrupting aesthetics.</p>
          </div>
        </div>
      </section>
