      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-6 md:px-16">
        ...
        <section className="min-h-screen flex flex-col lg:flex-row items-center pt-32 lg:pt-0 gap-16">
          ...
          <div className="lg:w-1/2 relative flex items-center justify-center w-full">
            ...
            >
              ...
              <img 
                src={HeroImg} 
                alt="Commercial Aroma Diffuser Solution" 
        ...
        <section className="py-32 border-t border-slate-100">
          <div className="mb-24 text-center max-w-4xl mx-auto">
            <h2 className="text-[11px] font-black uppercase tracking-[0.4em] text-blue-600 mb-6 font-sans">Commercial Units</h2>
            <h3 className="text-4xl md:text-7xl font-serif text-slate-900 tracking-tighter">Our Scent Collection</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              { img: Product1, name: "ProScent 2000", tag: "Versatile Retail Diffuser", desc: "A flexible scent machine that can be wall-mounted or placed on a shelf. It delivers powerful fragrance coverage for retail shops and mid-sized spaces.", suits: ["Fashion Boutiques", "Cafes", "Clinics"] },
              { img: Product2, name: "RetailAir Max", tag: "High-Traffic Area System", desc: "Built for busy environments, this durable diffuser maintains consistent scent intensity even during peak hours. Can be connected to HVAC or used standalone.", suits: ["Supermarkets", "Gyms", "Hotel Lobbies"] },
              { img: Product3, name: "OmniScent", tag: "Smart Business Diffuser", desc: "Featuring advanced programmable timers and app control (optional), this diffuser offers precise scent management for businesses with varying operating hours.", suits: ["Corporate Offices", "Banks", "Spas"] }
            ].map((product, idx) => (
              <motion.div 
                key={idx}
                whileHover={{ y: -10 }}
              ...
              >
                ...
                <h3 className="text-4xl font-serif text-slate-900 mb-2 tracking-tight">{product.name}</h3>
          ...
          <div className="relative rounded-[4rem] overflow-hidden bg-slate-50 border border-slate-100 shadow-xl">
            <div className="grid lg:grid-cols-2">
              ...
              <div className="relative min-h-[600px] overflow-hidden group">
                 <img src={FeatureImg} alt="Retail Scenting" className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-[2s]" />
        ...
        <section className="py-32">
          <div className="text-center mb-24">
            ...
            <h3 className="text-4xl md:text-7xl font-serif text-slate-900 tracking-tighter">Industries We Serve</h3>
        ...
        <section className="py-24 grid lg:grid-cols-2 gap-12 text-left">
          <div className="p-16 rounded-[4rem] bg-slate-900 text-white relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-4xl font-serif mb-10 relative z-10 tracking-tight">Cold-Air Diffusion Technology</h2>
            <p className="text-slate-400 mb-12 text-lg font-light leading-relaxed relative z-10 font-sans">
              Unlike traditional sprays or heated oils, our commercial diffusers use Cold-Air Diffusion (Nebulization). This breaks fragrance oil into dry nanoparticles that float in the air for hours.
            </p>
            <ul className="space-y-6 relative z-10 font-sans">
              {["No residue on furniture", "Preserves oil integrity", "Programmable scheduling", "Efficient coverage"].map((tech, i) => (
          ...
          <div className="p-16 rounded-[4rem] bg-white border border-slate-100 flex flex-col justify-center text-left shadow-sm">
            <h2 className="text-4xl font-serif text-slate-900 mb-10 tracking-tight">How to Choose the Right Diffuser</h2>
            <div className="space-y-4 font-sans">
              {[
                { label: "Coverage Area", desc: "Ensure the machine capacity matches your square footage." },
                { label: "Placement", desc: "Wall-mounted, standalone, or HVAC integration." },
                { label: "Operating Hours", desc: "Look for programmable timers to match business hours." },
                { label: "Scent Strategy", desc: "Customized for offices, luxury retail, or gyms." }
              ].map((item, i) => (
            ...
            <p className="mt-10 text-slate-400 text-sm italic font-light italic text-center font-sans">Our consultants can provide a free site assessment.</p>
          </div>
        </section>
