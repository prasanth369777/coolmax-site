      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-6 md:px-16">
        ...
        <section className="min-h-screen flex flex-col lg:flex-row items-center pt-32 lg:pt-0 gap-16">
          ...
          <div className="lg:w-1/2 flex flex-col items-start text-left z-20">
            ...
            >
              ...
              <h1 className="text-6xl md:text-8xl lg:text-7xl xl:text-9xl font-serif text-slate-900 tracking-tighter mb-8 leading-[0.95]">
                Large Area & <br />
                <span className="italic text-slate-400 font-light pr-2">HVAC</span> <br />
                Diffusers.
              </h1>
              ...
              <div className="p-8 bg-slate-50 border border-slate-200 rounded-[2.5rem] mb-10 max-w-xl shadow-sm text-left">
                <p className="text-base text-slate-600 leading-relaxed italic font-sans">
                  Cool Max offers high-performance aroma diffusers designed to scent expansive environments through central air conditioning systems or powerful standalone units.
                </p>
              </div>
          ...
          <div className="lg:w-1/2 relative flex items-center justify-center w-full">
            ...
            >
              ...
              <img 
                src={HeroImg} 
                alt="Large Area HVAC Diffuser Solution" 
        ...
        <section className="py-24 border-t border-slate-100">
          <div className="mb-24 text-center max-w-4xl mx-auto">
            <h2 className="text-[11px] font-black uppercase tracking-[0.4em] text-blue-600 mb-6 font-sans">Industrial Grade</h2>
            <h3 className="text-4xl md:text-7xl font-serif text-slate-900 tracking-tighter leading-none">Our Large Area Collection</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              { img: Product1, name: "HVAC-Pro 5000", tag: "Central Air Scent System", desc: "A powerful diffuser designed to connect directly to your HVAC ducts. It ensures invisible, even fragrance distribution throughout large buildings.", suits: ["Shopping Malls", "Hotels", "Large Offices"] },
              { img: Product2, name: "GrandSpace Tower", tag: "High-Capacity Standalone", desc: "A robust floor-standing unit designed for large open areas where HVAC connection isn't possible. Features massive oil capacity.", suits: ["Exhibition Halls", "Ballrooms", "Convention Centers"] },
              { img: Product3, name: "MegaMist Central", tag: "Multi-Zone Scent System", desc: "An advanced system capable of scenting multiple zones simultaneously. Ideal for complex multi-floor layouts.", suits: ["Department Stores", "Airports", "Hospitals"] }
            ].map((product, idx) => (
              <motion.div 
                key={idx}
                whileHover={{ y: -10 }}
              ...
              >
                <div className="h-80 w-full bg-white rounded-[2.5rem] mb-10 overflow-hidden flex items-center justify-center p-12 shadow-sm border border-slate-50">
          ...
          <div className="relative rounded-[4rem] overflow-hidden bg-slate-50 border border-slate-100 shadow-xl text-left">
            <div className="grid lg:grid-cols-2">
              <div className="p-10 md:p-24 flex flex-col justify-center bg-white">
                <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                  <h2 className="text-4xl md:text-6xl font-serif text-slate-900 mb-12 tracking-tighter leading-none">
                    Why Choose Large Area <br/>
                    <span className="italic text-slate-300 font-light">HVAC Diffusers?</span>
                  </h2>
                  ...
                  <ul className="space-y-8 font-sans">
                    {[
                      ...
                      { title: "Uniform Coverage", desc: "Uses airflow to distribute fragrance to every corner." },
              ...
              <div className="relative min-h-[600px] overflow-hidden group">
                 <img src={FeatureImg} alt="Large Scale Commercial Scenting" className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-[2s]" />
                 ...
                 <div className="absolute inset-x-0 bottom-0 p-12 bg-gradient-to-t from-slate-900 via-slate-900/40 to-transparent text-center">
                    <div className="p-10 bg-white/80 backdrop-blur-2xl rounded-3xl border border-white/50 shadow-2xl">
                      <p className="text-slate-900 font-serif text-3xl italic leading-tight">
                        "Uses airflow to distribute fragrance to every corner of the building."
                      </p>
                    </div>
                 </div>
              </div>
        ...
        <section className="py-32">
          <div className="text-center mb-24">
            ...
            <h3 className="text-4xl md:text-7xl font-serif text-slate-900 tracking-tighter leading-none">Common Applications</h3>
          </div>

          <div className="flex flex-wrap justify-center gap-10 font-sans">
            {[
              { title: "Shopping Malls", icon: <BuildingStorefrontIcon /> },
              { title: "Hotels & Resorts", icon: <BuildingOffice2Icon /> },
              { title: "Airports & Lounges", icon: <GlobeAltIcon /> },
              { title: "Convention Centers", icon: <ArrowsPointingOutIcon /> },
              { title: "Large Corporate Lobbies", icon: <ServerStackIcon /> }
            ].map((item, idx) => (
        ...
        <section className="py-24 grid lg:grid-cols-2 gap-12 text-left">
          <div className="p-16 rounded-[4rem] bg-slate-900 text-white relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-4xl font-serif mb-10 relative z-10 tracking-tight leading-none">How HVAC Scenting <br/> Works</h2>
            <p className="text-slate-400 mb-12 text-lg font-light leading-relaxed relative z-10 font-sans">
              Our systems connect to your existing AHU or HVAC ducts. Cold-air diffusion technology turns fragrance oil into a dry mist (nanoparticles) that travels with the conditioned air.
            </p>
            <ul className="space-y-6 relative z-10 font-sans">
              {["No residue in ducts", "Consistent scent intensity", "Centralized control", "Massive coverage area"].map((tech, i) => (
          ...
          <div className="p-16 rounded-[4rem] bg-white border border-slate-100 flex flex-col justify-center text-left shadow-sm">
            ...
            <div className="space-y-4 font-sans">
              {[
                { label: "AC System Type", desc: "Central AC with ducts? HVAC models are best." },
                { label: "Ceiling Height", desc: "High ceilings require more powerful output." },
                { label: "Coverage Area", desc: "Total volume (m³) matched to diffuser capacity." },
                { label: "Operating Hours", desc: "24/7 facilities need larger oil reservoirs." }
              ].map((item, i) => (
        ...
        <section className="py-24">
          <div className="bg-slate-900 rounded-[5rem] p-16 md:p-32 text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <p className="text-2xl font-serif italic text-white/50">"Scalable solutions for businesses that demand excellence."</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-32 text-center bg-slate-50 rounded-[5rem] mb-20 border border-slate-200 shadow-sm">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="max-w-4xl mx-auto px-6">
            <h2 className="text-5xl md:text-8xl font-serif text-slate-900 mb-12 tracking-tighter leading-none">
              Need to Scent a <br/> 
              <span className="italic text-blue-600 font-light">Large Space?</span>
            </h2>
